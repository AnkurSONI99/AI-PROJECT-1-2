...
def analyzeTone(text):
    tone_analyzer = ToneAnalyzerV3(
        version='2017-09-21',
        iam_apikey='yDOnra0zihmRpjVvVD4xeiIRqYt5iMPBPpBiTvfkTGZI',
        url='https://api.us-south.tone-analyzer.watson.cloud.ibm.com/instances/0baec9ab-df56-44d0-aca4-94af2f36b4ae'
    )
